  ...
  return (
    <>
      <Router>
        <Navbar/>
        <Routes>
          <Route path='/' element={<News newsCategory='general' headerTitle="Top News" headerText="All the hottest news around the world!" headerImg="\general.jpg" headerDescription="general-image"/>}/>
